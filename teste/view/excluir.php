...
<body>
  ...
  <section class="sectionform">
    <div class="formprincipalexcluir">
      <form action="../controller/processa_form.php" method="POST">
        <input type="hidden" name="acao" value="excluir">
        <div class="cpfexcluir">
          <p>CPF</p>
          <input type="text" name="cpf" class="barra2excluir" maxlength="11" minlength="11" pattern="\d{11}"
            placeholder="Digite seu CPF">
        </div>
        <div class="botoesformexcluir">
          <input type="reset" class="redefinirexcluir" name="resetarform">
          <input type="submit" class="enviarexcluir" name="enviarform" value="Excluir">
        </div>
      </form>
    </div>
  </section>
